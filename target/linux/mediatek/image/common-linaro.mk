define Device/LinaroPackages
  # usb storage support
  DEVICE_PACKAGES += kmod-usb-storage kmod-usb-storage-uas kmod-fs-ext4 kmod-fs-exfat exfat-fsck block-mount
  # netfilter nathelper
  DEVICE_PACKAGES += kmod-nf-nathelper kmod-nf-nathelper-extra
  # ipv6 nat support
  DEVICE_PACKAGES += kmod-nf-nat6
  # net tools
  DEVICE_PACKAGES += iperf3 tcpdump openssh-sftp-server pppoe-discovery
  # sys utils
  DEVICE_PACKAGES += screen nano mmc-utils mc shadow-utils shadow-useradd shadow-userdel shadow-usermod
  # timezones
