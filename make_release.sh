...
# Create C20v1 Tftp
cat fwbin/uboot_c20v1.bin bin/targets/ramips/mt7620/openwrt-${OWRT}-ramips-mt7620-tplink_c20-v1-squashfs-sysupgrade.bin > ArcherC20V1_tp_recovery.bin
7z a -sdel -tzip TPLinkArcherC20V1_Tftp.zip ArcherC20V1_tp_recovery.bin

# Create C20v4 Tftp
cat fwbin/uboot_c20v4.bin bin/targets/ramips/mt76x8/openwrt-${OWRT}-ramips-mt76x8-tplink_c20-v4-squashfs-sysupgrade.bin > tp_recovery.bin
